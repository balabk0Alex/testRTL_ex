...
- Тест из 8 комбинаций (режим 2)
- Тест, обеспечивающий полное покрытие всех 262144 состояний (режим 3)
...
| g++ | 11.0+ (C++17) |
| make | 4.0+ |
| lcov | 1.15+ (опционально, для отчётов покрытия) |
| gtkwave | 3.3+ (опционально, для просмотра波形) |
